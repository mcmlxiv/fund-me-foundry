...
//2. Keep trackof contract addresses accros different chains
//Sepolia ETH/USD
//Mainnet ETH/USD
...
contract HelperConfig is Script {
    ...
    // otherwise, grab the existing adddress from the live network
    ...
    function createAnvilEthConfig() public returns (NetworkConfig memory) {
        if (activeNetworkConfig.priceFeed != address(0)) {
            //if the pricefeed has been set up as something just return and dont run the rest of the function
